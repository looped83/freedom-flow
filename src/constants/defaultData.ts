...
export const DEFAULT_GOALS: Goal[] = [
  ...
  { id: id(), name: 'GEZ',                  monthlyAmount:  18.36, category: 'Streaming',     emoji: '📺' },
  ...
  { id: id(), name: 'DivvyDiary',           monthlyAmount:   2.75, category: 'Streaming',     emoji: '📊' },
  ...
  { id: id(), name: 'Arzt (Paul)',          monthlyAmount: 100.00, category: 'Haustiere',     emoji: '🩺' },
